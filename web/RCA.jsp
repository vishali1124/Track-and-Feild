    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X100Relay' and etype='relay' ORDER BY record asc LIMIT 0,1) pp";
    ...
    <body>
        ...
        <%
            try{
                ...
                qry1="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X100Relay' and etype='relay' ORDER BY record asc LIMIT 1,1) pp";
        ...
        <%
            try{
                ...
                qry2="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X100Relay' and etype='relay' ORDER BY record asc LIMIT 2,1) pp";
        ...
        <%
            try{
                ...
                qry3="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X400Relay' and etype='relay' ORDER BY record asc LIMIT 0,1) pp";
        ...
        <%
            try{
                ...
                qry5="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X400Relay' and etype='relay' ORDER BY record asc LIMIT 1,1) pp";
        ...
        <%
            try{
                ...
                qry6="SELECT * FROM (SELECT eid,faculty,ename,record,points FROM placesaf WHERE type='Annual' AND ename='4X400Relay' and etype='relay' ORDER BY record asc LIMIT 2,1) pp";
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                response.sendRedirect("./RC1A.jsp");
            } catch(ClassNotFoundException cnfe){
               System.out.println("Class not found exception" + cnfe.toString());
            } catch(SQLException sqle){
                out.println("SQL eCXCEPTION " + sqle);
     ...
     <div class="container">
     <form id="addDistributor" action="RCA.jsp" method="POST" name="" onsubmit="">

   <div class="form-group">
       <label for="email"><b>Sportsmeet Type:</b></label>
    <input type="checkbox" class="form-control" name="stype" value="Annual" id="stype" checked>Annual
    <input type="checkbox" class="form-control" name="stype" value="freshers" id="stype" >Freshers
