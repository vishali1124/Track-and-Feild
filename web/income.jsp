<%-- 
    Document   : income
    Created on : Aug 11, 2018, 9:23:34 AM
    Author     : User
--%>
...
<html>
    ...
    <body onload="displayCalendar()">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
        <h1>Event Income Details- Inter Faculty Championship- 2018</h1>
        <br><br><br>
...
%>
<tr>
<td><%=resultSet.getString("inid") %></td>
...
<a href="insertIncome.jsp"><button>Insert Income Details</button></a><br><br>
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
...
Total Amount of Income : <%=resultSet.getString("totalIncome") %>
    
<br>
<form action="insertServlet" method="post">
    <input type="hidden" name="income" value="<%=resultSet.getString("totalIncome") %>"/>
