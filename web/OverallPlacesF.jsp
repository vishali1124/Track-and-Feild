...
<link href="External/fontawesome/css/all.css" rel="stylesheet" type="text/css"/>
        ...
        <title>Overall Places Freshers</title>
    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 0,1) pp";
    ...
    <body>
        ...
        <table style="width:100%;align:center">
            ...
            <tr>
                ...
                %>
                    ...
                    <td align='center'><%=result.getString("TotalPoints")%></td>
        ...
        <%
            try{
                ...
                qry1="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 1,1) pp";
         ...
         <table style="width:100%;align:center">
            ...
            <tr>
                ...
                %>
                    ...
                    <td align='center'><%=result1.getString("faculty")%></td>
                    <td align='center'><%=result1.getString("TotalPoints")%></td>
        ...
        <%
            try{
                ...
                qry2="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 2,1) pp";
         ...
         <table style="width:100%;align:center">
            ...
            <tr>
                ...
                %>
                    ...
                    <td align='center'><%=result2.getString("faculty")%></td>
                    <td align='center'><%=result2.getString("TotalPoints")%></td>
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                response.sendRedirect("./OverallPlacesFView.jsp");
            } catch(ClassNotFoundException cnfe){
               System.out.println("Class not found exception" + cnfe.toString());
            } catch(SQLException sqle){
                out.println("SQL eCXCEPTION " + sqle);
      ...
      <form id="addDistributor" action="OverallPlacesF.jsp" method="POST" name="" onsubmit="">
         ...
         <table border="0" cellspacing="5" cellpadding="5"> 
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <input type="checkbox" name="stype" value="Annual"  >Annual
                        
                        <input type="checkbox" name="stype" value="freshers" checked>Freshers</td>
                    </tr>
