...
<html>
    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Art' AND gender='male'";
        ...
        <%
            try{
                ...
                qry1="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Science' AND gender='male'";
        ...
        <%
            try{
                ...
                qry2="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Management Studies And Commerce' AND gender='male'";
        ...
        <%
            try{
                ...
                qry3="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Medicine' AND gender='male'";
        ...
        <%
            try{
                ...
                qry4="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Business Studies' AND gender='male'";
        ...
        <%
            try{
                ...
                qry5="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Applied Science' AND gender='male'";
        ...
        <%
            try{
                ...
                qry6="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Agriculture' AND gender='male'";
        ...
        <%
            try{
                ...
                qry7="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Engineering' AND gender='male'";
        ...
        <%
            try{
                ...
                qry8="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Department Of Siddha Medicine' AND gender='male'";
        ...
        <%
            try{
                ...
                qry9="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Allied Health Science Unit' AND gender='male'";
        ...
        <%
            try{
                ...
                qry10="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Technology' AND gender='male'";
        ...
        <%
            try{
                ...
                qryy="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Art' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy1="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Science' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy2="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Management Studies And Commerce' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy3="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Medicine' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy4="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Business Studies' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy5="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Applied Science' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy6="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Agriculture' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy7="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Engineering' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy8="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Department Of Siddha Medicine' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy9="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Allied Health Science Unit' AND gender='female'";
        ...
        <%
            try{
                ...
                qryy10="SELECT eid,COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Technology' AND gender='female'";
    ...
    String sqAl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Art' AND gender='male'";
    ...
    String sqA2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Art' AND gender='female'";
    ...
    int totalPointsA = FacultyPoints.CalculateFacultyPointsA(MaleFacultyPointsA,FemaleFacultyPointsA);
        ...
        String sqBl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Science' AND gender='male'";
    ...
    String sqB2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Science' AND gender='female'";
    ...
    int totalPointsB = FacultyPoints.CalculateFacultyPointsB(MaleFacultyPointsB,FemaleFacultyPointsB);
            ...
            String sqCl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Management Studies And Commerce' AND gender='male'";
    ...
    String sqC2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Management Studies And Commerce' AND gender='female'";
    ...
    String sqDl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Medicine' AND gender='male'";
    ...
    String sqD2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Medicine' AND gender='female'";
    ...
    int totalPointsD = FacultyPoints.CalculateFacultyPointsD(MaleFacultyPointsD,FemaleFacultyPointsD);
           ...
           String sqEl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Business Studies' AND gender='male'";
   ...
   String CountRowE1="";
    ...
    String sqE2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Business Studies' AND gender='female'";
    ...
    String sqFl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Applied Science' AND gender='male'";
    ...
    String sqF2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Applied Science' AND gender='female'";
    ...
    int totalPointsF = FacultyPoints.CalculateFacultyPointsF(MaleFacultyPointsF,FemaleFacultyPointsF);
     ...
     String sqGl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Agriculture' AND gender='male'";
    ...
    String sqG2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Agriculture' AND gender='female'";
    ...
    int totalPointsG = FacultyPoints.CalculateFacultyPointsG(MaleFacultyPointsG,FemaleFacultyPointsG);
      ...
      String sqHl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Engineering' AND gender='male'";
    ...
    String sqH2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Engineering' AND gender='female'";
    ...
    int totalPointsH = FacultyPoints.CalculateFacultyPointsH(MaleFacultyPointsH,FemaleFacultyPointsH);
     ...
     String sqIl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Department Of Siddha Medicine' AND gender='male'";
    ...
    String sqI2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Department Of Siddha Medicine' AND gender='female'";
    ...
    String sqJl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Allied Health Science Unit' AND gender='male'";
    ...
    String sqJ2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Allied Health Science Unit' AND gender='female'";
    ...
    String sqKl="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Technology' AND gender='male'";
    ...
    String sqK2="SELECT COALESCE(SUM(`points`),0) AS POINTS FROM placesaf WHERE type='Annual' AND faculty='Faculty Of Technology' AND gender='female'";
 ...
 <body>
            ...
            <h4 align='center'>INTER FACULTY ANNUAL' TRACK & FIELD CHAMPIONSHIP</h4>
