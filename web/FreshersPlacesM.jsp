...
<html>
    <head>
        ...
        <title>Freshers' Places Men</title>
    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT * FROM (SELECT eid,faculty,SUM(points) as total FROM placesaf WHERE gender='male' AND type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 0,1) pp";
    ...
    <body>
        ...
        <%
            try{
                ...
                qry1="SELECT * FROM (SELECT eid,faculty,SUM(points) as total FROM placesaf WHERE gender='male' AND type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 1,1) pp";
        ...
        <%
            try{
                ...
                qry2="SELECT * FROM (SELECT eid,faculty,SUM(points) as total FROM placesaf WHERE gender='male' AND type='freshers' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 2,1) pp";
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                response.sendRedirect("./FreshersPMView.jsp");
            } catch(ClassNotFoundException cnfe){
               System.out.println("Class not found exception" + cnfe.toString());
            } catch(SQLException sqle){
                out.println("SQL eCXCEPTION " + sqle);
      ...
      <form id="addDistributor" action="FreshersPlacesM.jsp" method="POST" name="" onsubmit="">
