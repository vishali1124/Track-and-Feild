                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="#">Update Events</a>
                            <a class="dropdown-item" href="#">Delete Events</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="#">Add Meet Manager</a>
                            <a class="dropdown-item" href="#">Update Meet Manager</a>
                            <a class="dropdown-item" href="#">Delete Meet Manager</a>
                        </div>
                    </li>
                </ul>
            </div>
		...
		<div class="row">
				...
				<div class="jumbotron" style="width:100%; height:100%">
                                    <div class="card-group">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title" align="center"> <a href="eventAdd.jsp" class="btn btn-primary" style="width: 165px;">Events</a></h5>
                                          </div>
                                        </div>
                                        ...
                                        <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                                          <img class="card-img-top" src="pics/inventory.png" alt="Card image cap">
                                          <div class="card-body">
                                             <h5 class="card-title" align="center"> <a href="eventDelete.jsp" class="btn btn-primary " style="width: 165px;">Event Chart</a></h5>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="card-group">
                                            ...
                                            <img class="card-img-top" src="pics/inventory.png" alt="Card image cap">
                                            <div class="card-body">
                                            <h5 class="card-title" align="center"> <a href="#" class="btn btn-primary" style="width: 165px;">Meet Manager</a></h5>
                                          </div>
                                        </div>
