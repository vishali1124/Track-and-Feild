...
public final class addMM_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet resultSet = null;
      ...
      out.write("            </div>\n");
      out.write("        </nav>\n");
      out.write("        <h1 style=\"color: darkslateblue\" align=\"center\">Assign Meet Manager</h1>\n");
      out.write("        <br><br><br>\n");
      out.write("        \n");
      out.write("        \n");
      ...
      out.write("                        <tr>\n");
      out.write("                            <th>Meet Manager ID</th>   \n");
      out.write("                            <th>Meet Manager Name</th>\n");
      out.write("                        </tr>  \n");
...
while(resultSet.next()){
      ...
      out.write("\n");
      out.write("                            <td>\n");
      out.write("                                <form action=\"assignMM.jsp\" method=\"POST\">\n");
      ...
      out.write("\" hidden>\n");
      out.write("                                    \n");
      out.write("                                    <button type=\"submit\" name=\"Assign\">Assign</button>\n");
      out.write("                                </form>\n");
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      out.write("                                <form action=\"TasksMM.jsp\" method=\"POST\">\n");
      out.write("                                    <input name=\"userid\" type=\"text\" value=\"");
      out.print(resultSet.getString("userid") );
      out.write("\" hidden>\n");
      out.write("                                    <input name=\"username\" type=\"text\" value=\"");
      out.print(resultSet.getString("username") );
      out.write("\" hidden>\n");
      out.write("                                    <button type=\"submit\" name=\"Tasks\">Tasks</button>\n");
      out.write("                                </form>\n");
      out.write("                            </td>\n");
      out.write("                        </tr>\n");
...
connection.close();
      ...
      out.write("\n");
      out.write("                        <tr>\n");
      out.write("                            <td><button type=\"submit\" name=\"back\" align=\"center\" onclick=\"location.href='MMhome.jsp'\">Back</button></td>                            \n");
      out.write("                        </tr>\n");
      out.write("                    </table>\n");
      out.write("                    </div>\n");
      ...
      out.write("                            <p class=\"card-text\"><i class=\"fas fa-user\">&nbsp;</i>Malith Priyasad</p>\n");
      out.write("                            <p class=\"card-text\"><i class=\"fa fa-user-cog\">&nbsp;</i>Admin</p>\n");
