...
public final class StudentPL_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 DBConnector dc = new DBConnector();
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" name=\"SportsID\" required></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>Participant Name :</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" name=\"PartName\" required></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>100m :</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><select name=\"Hundred\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"true\">true</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"false\">false</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><select name=\"Highj\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"true\">true</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"false\">false</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><select name=\"Longj\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"true\">true</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"false\">false</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><select name=\"Eight\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"true\">true</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"false\">false</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\r\n");
      out.write("*/\r\n");
      out.write("var elementArr = [];\r\n");
      out.write("\r\n");
      out.write("function highlight(sender) {\r\n");
      out.write("\tvar trueCount = 0;\r\n");
      out.write("\tvar element = document.getElementById(sender);\r\n");
      out.write("\tvar hundred = document.getElementById(sender).attributes[\"hundred\"].value;\r\n");
      out.write("\tvar Twoh = document.getElementById(sender).attributes[\"Twoh\"].value;\r\n");
      out.write("\tvar Highj = document.getElementById(sender).attributes[\"Highj\"].value;\r\n");
      out.write("\tvar Longj = document.getElementById(sender).attributes[\"Longj\"].value;\r\n");
      out.write("\tvar Eight = document.getElementById(sender).attributes[\"Eight\"].value;\r\n");
      out.write("\t\r\n");
      out.write("\telementArr[0] = hundred;\r\n");
      out.write("\telementArr[1] = Twoh;\r\n");
      out.write("\telementArr[2] = Highj;\r\n");
      out.write("\telementArr[3] = Longj;\r\n");
      out.write("\telementArr[4] = Eight;\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tfor (var i = 0; i < elementArr.length; i++) {\r\n");
      out.write("\t\tif (elementArr[i] == \"true\") {\r\n");
      out.write("\t\t\ttrueCount++;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tif (trueCount > 3) {\r\n");
      out.write("\t\talert(\"greater than 3\");\r\n");
      out.write("\t\telement.style.backgroundColor = \"red\";\r\n");
      out.write("\t}\r\n");
      out.write("\telse {\r\n");
      out.write("\t\talert(\"less than 3\");\r\n");
      out.write("\t}\r\n");
      out.write("\t//elementArr[elementArr.length] = sender;\r\n");
      out.write("\t//row.style.backgroundColor = \"red\";\r\n");
      out.write("\t/*for (var i = 0, len = element.length; i < len; i++) {\r\n");
      out.write("\t\telement[i].style.backgroundColor = \"red\";\t\r\n");
      out.write("\t}*/\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("\r\n");
