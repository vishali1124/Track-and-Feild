...
<html>
    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT * FROM (SELECT eid,sname,faculty,ename,record,points FROM placesaf WHERE type='freshers' AND etype='track' AND gender='male' ORDER BY record asc LIMIT 0,1) pp";
       ...
       Track Events</h2>
        ...
        <%
            try{
                ...
                qry1="SELECT * FROM (SELECT eid,sname,faculty,ename,record,points FROM placesaf WHERE type='freshers' AND etype='track' AND gender='female' ORDER BY record asc LIMIT 0,1) pp";
        ...
        <%
            try{
                ...
                qry2="SELECT * FROM (SELECT eid,sname,faculty,ename,record,points FROM placesaf WHERE type='freshers' AND etype='field' AND gender='male' ORDER BY record desc LIMIT 0,1) pp";
    ...
    Field Events</h2>
        ...
        <%
            try{
                ...
                qry3="SELECT * FROM (SELECT eid,sname,faculty,ename,record,points FROM placesaf WHERE type='freshers' AND etype='field' AND gender='female' ORDER BY record desc LIMIT 0,1) pp";
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                response.sendRedirect("./BP1F.jsp");
            } catch(ClassNotFoundException cnfe){
               System.out.println("Class not found exception" + cnfe.toString());
            } catch(SQLException sqle){
                out.println("SQL eCXCEPTION " + sqle);
    ...
    <div class="container">
     <form id="addDistributor" action="BPF.jsp" method="POST" name="" onsubmit="">
