<%-- 
    Document   : CAhomeRecorder
    Created on : Sep 30, 2018, 5:59:03 AM
    Author     : vishali
--%>
        ...
        <div class="container">
			...
			<div class="card-group">
                          ...
                          <div class="card" style="width: 5px; height: 300px">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="PlaceTheStudents1.jsp" class="btn btn-primary" style="width: 165px;">Place The Students</a></h5>                                          </div>
                            </div>
                            <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 70px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="RecordsR.jsp" class="btn btn-primary" style="width: 165px;">Records</a></h5>
                            </div>
                           </div>
