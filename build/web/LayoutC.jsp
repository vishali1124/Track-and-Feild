    ...
    <body>
        <center>
            ...
            <nav class="navbar navbar-light" style="background-color: #e3f2fd; width:100%;">
                <a class="nav-link" href="CAhomeCW.html">Home<span class="sr-only">(current)</span></a>

                <a class="nav-link" href="Records.jsp">Records<span class="sr-only">(current)</span></a>
                <a class="nav-link" href="ResultsCW.jsp">Results<span class="sr-only">(current)</span></a>
                <a class="nav-link" href="PrizeListCW.jsp">Prize List<span class="sr-only">(current)</span></a>
                <a class="nav-link" href="StudentPerformance1.jsp">Student Performance<span class="sr-only">(current)</span></a>
                <a class="nav-link" href="Points.html">Faculty Performance<span class="sr-only">(current)</span></a>
