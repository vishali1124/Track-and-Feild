<%-- 
    Document   : OutstandingAthleteOfTheMeet2A
    Created on : Sep 30, 2018, 6:51:29 AM
    Author     : vishali
--%>
...
<html>
       <head>
<title>OAOTM view distributors</title>
<meta charset="utf-8">
...
<section>
  ...
  <tr>
	...
	<div class="icon">
	<br><br>
	<a href="OutstandingAthleteOfTheMeetAView.jsp">
	<img src="pictures/tdicon2.jpg" height="70%" width="80%"></a>
	<br>
    <h5>Annual Sportsmeet</h5>
	</div>
	</td>
	...
	<div class="icon">
	<br><br>
	<a href="OutstandingAthleteOfTheMeetFView.jsp">
	<img src="pictures/tdicon2.jpg" height="70%" width="80%"></a>
	<br>
    <h5>Freshers' Sportsmeet</h5>
	</div>
	</td>
