...
<html>
    ...
    try{
        ...
        int i = stmt.executeUpdate("INSERT INTO income(inid,incomeType,name,amount,date)VALUES('"+inid+"','"+incomeType+"','"+name+"','"+amount+"','"+date+"')");
...
<h1>INSERT INCOME DETAILS</h1>
        <form method="post" name="insertForm"  onsubmit="">
            Income Id : <input type="text" name="inid" required="required">
            <br><br><br>
            Income Type(Government/sponsor)  : <input type="text" name="incomeType" required="required">
            <br><br><br>
            ...
            <br><br><br>
            <button><a href="income.jsp">View Income Details</a></button>
        </form>
                </div>
