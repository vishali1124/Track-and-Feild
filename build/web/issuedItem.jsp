...
<html>
    ...
    <body>
        ...
        <center>
            <h3 style="color: #000033;"><span class="badge badge-primary" style="width: 500px;">Issued Item Table</span></h3> 
            ...
            <div style="width: 1330px;" >       
                <table class="table">
                    ...
                    <%
                        ...
                        if(query!=null){
                           sql="SELECT * FROM inventorybooking where itype like '%"+query+"%' or itemName like '%"+query+"%' or EventName like '%"+query+"%'  ";
                        }else{
                           sql="SELECT * FROM inventorybooking";
                        }
