<%-- 
    Document   : AssignMM
    Created on : Aug 26, 2018, 10:44:23 AM
    Author     : Erandi
--%>
                        ...
                        <div class="jumbotron" style="width:100%; height:100%;">
                            <div class="card-group">
                                <div class="card" style="width: 5px; height: 300px">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title" align="center"> <a href="addMM.jsp" class="btn btn-primary" style="width: 165px;">Add MM</a></h5>
                                    </div>
                                </div>
                                ...
                                <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                                    <img class="card-img-top" src="pics/inventory.png" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title" align="center"> <a href="" class="btn btn-primary " style="width: 165px;">Show MM</a></h5>
                                    </div>
                                </div>
                            </div>
