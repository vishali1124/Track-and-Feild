        ...
        <div class="container">
			...
			<div class="card-group">           
                           <div class="card" style="width: 5px; height: 300px">
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 10px; margin-top: 10px;">
                            
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="CAhomeRecorder.jsp" class="btn btn-primary" style="width: 165px;">Recorder</a></h5>                                          </div>
                            </div>
                            
                            <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 10px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="CAhomeCW.jsp" class="btn btn-primary" style="width: 165px;">Certificate Writers</a></h5>
                            </div>
                           </div>
                            ...
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 10px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="CAhomeEPM.jsp" class="btn btn-primary" style="width: 165px;">Event Manager</a></h5>
                            </div>
                           </div>
