        ...
        <div class="container">
			...
			<div class="card-group">
                            ...
                            <div class="card" style="width: 5px; height: 300px">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title" align="center"> <a href="#" class="btn btn-primary" style="width: 165px;" onclick="location.href='BestPerformanceEPM.jsp'">Best Performance</a></h5>
                                </div>
                            </div>
                            ...
                            <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                                <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap"  style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                                <div class="card-body">
                                    <h5 class="card-title" align="center"> <a href="#popup1" onclick="document.location.href='RelayChampion.jsp'" class="btn btn-primary" style="width: 165px;">Relay Champion</a></h5>
                                </div>
                            </div>
                            ...
                            <div class="card" style="margin-left: 20px;width: 5px; height: 300px">
                                <img class="card-img-top"  src="pictures/tdicon2.jpg"  alt="Card image cap"  style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                                <div class="card-body">
                                    <h5 class="card-title" align="center"> <a href="#" onclick="document.location.href='RecordHolders.jsp'"  class="btn btn-primary " style="width: 165px;">Record Holders</a></h5>
                                </div>
                            </div>
                        ...
                        <div class="card-group">
                            ...
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="OutstandingAthleteOfTheMeet.jsp" class="btn btn-primary" style="width: 165px;">Outstanding Athlete</a></h5>                                          </div>
                            </div>
                            ...
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="Points.jsp" class="btn btn-primary" style="width: 165px;">Points</a></h5>                                          </div>
                            </div>
                            ...
                            <img class="card-img-top" src="pictures/tdicon2.jpg" alt="Card image cap" style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                            <div class="card-body">
                                <h5 class="card-title" align="center"> <a href="Places.jsp" class="btn btn-primary" style="width: 165px;">Places</a></h5>
                            </div>
                        </div>
                        ...
                        <br>
                         <div class="card-group">
                           ...
                           <div class="card" style="width: 8px; height: 300px">
                                <img class="card-img-top"  src="pictures/tdicon2.jpg"  alt="Card image cap"  style="width: 185px; height: 180px; margin-left: 12px; margin-top: 10px;">
                                <div class="card-body">
                                    <h5 class="card-title"> <a href="#" onclick="document.location.href='OverallPlaces.jsp'"  class="btn btn-primary " style="width: 165px;">Overall Places</a></h5>
                                </div>
                           </div>
