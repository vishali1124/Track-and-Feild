...
<html>
    <head>
        ...
        <title>Overall Places Annual</title>
    ...
    <%!
        ...
        <%
            try{
                ...
                qry="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='Annual' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 0,1) pp";
    ...
    <body>
        ...
        <%
            try{
                ...
                qry1="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='Annual' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 1,1) pp";
        ...
        <%
            try{
                ...
                qry2="SELECT * FROM (SELECT eid,faculty,COALESCE(SUM(`points`),0) AS TotalPoints FROM placesaf WHERE type='Annual' GROUP BY faculty ORDER BY (SUM(points)) desc LIMIT 2,1) pp";
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                response.sendRedirect("./OverallPlacesAView.jsp");
            } catch(ClassNotFoundException cnfe){
               System.out.println("Class not found exception" + cnfe.toString());
            } catch(SQLException sqle){
                out.println("SQL eCXCEPTION " + sqle);
      ...
      <form id="addDistributor" action="OverallPlacesA.jsp" method="POST" name="" onsubmit="">
